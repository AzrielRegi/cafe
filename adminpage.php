...
<html lang="en">
    <head>
        ...
        <title>World Cafe Admin - Home</title>
        <!-- Favicon-->
    ...
    <body>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item"><a class="nav-link active" aria-current="page" href="adminpage.php">Home</a></li>
        ...
        <div class="section" style="margin-top:25px ;">
            <div class="container">
                <div class="box">
                    <h5>Welcome <?=$_SESSION['name']?> in World Restaurant</h5>
                </div>
            </div>
        </div>
