...
<html lang="en">
    <head>
        ...
        <title>Shop Homepage - World Cafe</title>
        <!-- Favicon-->
    ...
    <body>
        ...
        <header class="bg-dark py-5">
            <div class="container px-4 px-lg-5 my-5">
                ...
                <h1 class="display-4 fw-bolder">Welcome to World Cafe</h1>
        ...
        <div class="search">
            <div class="container" style="padding: 0 10vh 0 25vh;">
                <form action="produk-disewa.php">
                    <input type="text" name="search" placeholder="Search" class="col-md-8">
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 mt-5">
                ...
                <?php
                                $getdata = mysqli_query($dbconn, "SELECT * FROM product WHERE status = 1 ORDER BY id_product ASC LIMIT 8");
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; RFL CosplayRent 2023</p></div>
        </footer>
        <!-- Bootstrap core JS-->
