...
$produk = mysqli_query($dbconn, "SELECT * FROM product WHERE id_product = '".$_GET['id']."'");
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6">
                        <img class="card-img-top mb-5 mb-md-0" src="menus/<?= $p->image?>" />
                    </div>
                    <div class="col-md-6">
                        <h1 class="display-5 fw-bolder"><?= $p->product_name?></h1>
                        <div class="fs-5 mb-5">
                            <span>Rp. <?= number_format($p->price)?></span>
                        </div>
                        <p class="lead"><?= $p->description?></p>
                        <form action="cart-add.php?id=<?=$p->id_product?>" method="post">
                        <div class="d-flex">
                            <input class="form-control text-center me-3" id="inputQuantity" type="num" value="1" style="max-width: 3rem" name="qty"/>
